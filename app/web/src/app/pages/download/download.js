         ...
         <div className="container-xl mt-2 ">
            ...
            <div className="row">
               ...
               <div className="col-8 col-sm-5 col-md-5 col-lg-3 mb-2 m-auto">
                  <div className="card text-center p-1 pt-3">
                     <div className="avatar avatar-xl m-auto m-4 mb-3">
                        <svg xmlns="http://www.w3.org/2000/svg" className="icon" width="24" height="24" viewBox="0 0 24 24" stroke-width="2" stroke="currentColor" fill="none" stroke-linecap="round" stroke-linejoin="round"><path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M8 9l3 3l-3 3" /><line x1="13" y1="15" x2="16" y2="15" /><rect x="3" y="4" width="18" height="16" rx="2" /></svg>
                     </div>
